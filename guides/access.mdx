...
Regular users do not open Admin Center. They still see **Billing** for plan and usage if they need it, but only owners and administrators can start checkout or open the Stripe portal.
